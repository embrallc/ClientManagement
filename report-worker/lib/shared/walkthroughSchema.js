// VENDORED COPY — keep in sync with /shared/walkthroughSchema.js.
// The worker deploys with build context = report-worker/ only, so the repo's
// /shared modules aren't in the Docker image; they're mirrored here. The
// renderer uses SEVERITY_LEVELS; the rest is copied verbatim for fidelity.
// ─────────────────────────────────────────────────────────────────────────────
